"""Temporary helper: write the original source and diff against new."""
...
root = pathlib.Path(__file__).parent.parent.parent.parent  # thesis_repository
new_path = root / "final_dataset_creation/dataset_construction/scripts/compute_controls.py"
new = new_path.read_text(encoding="utf-8")

diff = difflib.unified_diff(
    ORIG.splitlines(keepends=True),
    new.splitlines(keepends=True),
    fromfile="a/scripts/compute_controls.py",
    tofile="b/scripts/compute_controls.py",
)
print("".join(diff))
